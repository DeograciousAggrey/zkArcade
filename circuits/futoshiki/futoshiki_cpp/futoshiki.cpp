...
void Futoshiki_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Futoshiki_7_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 2981;}

uint get_number_of_components() {return 385;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 2353;}
...
ctx->componentMemory[coffset].templateName = "Futoshiki";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 56;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[184]{0};
}
...
uint csoffset = mySignalStart+2340;
uint aux_dimensions[2] = {4,4};
for (uint i = 0; i < 16; i++) {
std::string new_cmp_name = "letfour"+ctx->generate_position_array(aux_dimensions, 2, i);
...
uint csoffset = mySignalStart+1692;
uint aux_dimensions[2] = {4,4};
for (uint i = 0; i < 16; i++) {
...
uint csoffset = mySignalStart+2220;
uint aux_dimensions[2] = {4,4};
for (uint i = 0; i < 16; i++) {
...
uint csoffset = mySignalStart+2076;
...
uint csoffset = mySignalStart+1788;
uint aux_dimensions[1] = {24};
for (uint i = 0; i < 24; i++) {
...
for (uint i = 0; i < 12; i++) {
std::string new_cmp_name = "gtRows"+ctx->generate_position_array(aux_dimensions, 1, i);
...
uint csoffset = mySignalStart+732;
uint aux_dimensions[1] = {12};
for (uint i = 0; i < 12; i++) {
std::string new_cmp_name = "gtCols"+ctx->generate_position_array(aux_dimensions, 1, i);
GreaterThan_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 40 ;
aux_cmp_num += 3;
...
uint csoffset = mySignalStart+1932;
uint aux_dimensions[1] = {24};
for (uint i = 0; i < 24; i++) {
std::string new_cmp_name = "ieIneq"+ctx->generate_position_array(aux_dimensions, 1, i);
IsEqual_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 2;
...
uint csoffset = mySignalStart+2268;
uint aux_dimensions[1] = {24};
for (uint i = 0; i < 24; i++) {
std::string new_cmp_name = "izIneq"+ctx->generate_position_array(aux_dimensions, 1, i);
IsZero_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 3 ;
aux_cmp_num += 1;
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 23
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 24
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 16);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 40)]);
}
...
cmp_index_ref_load = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 16);
cmp_index_ref_load = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 16)]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0)]].signalStart + 0]); // line circom 33
}}
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 33. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 23
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 23
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 45
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 46
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 32);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
{
uint cmp_index_ref = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 48);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
cmp_index_ref_load = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 32);
cmp_index_ref_load = (((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 48);
Fr_sub(&expaux[1],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 48)]].signalStart + 0]); // line circom 54
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((4 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 32)]].signalStart + 0],&expaux[1]); // line circom 54
}}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 68
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 69
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 70
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[0])) + 64);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[3]))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 64);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 64)]].signalStart + 0],&circuitConstants[1]); // line circom 74
}}
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 70
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 69
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 69
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 90
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 91
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[4],&lvar[2]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 88);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[3]))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[3]))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 88);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 88)]].signalStart + 0],&circuitConstants[1]); // line circom 96
}}
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 92
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&lvar[2]); // line circom 92
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 90
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 90
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 118
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[6]); // line circom 119
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[3])) + 112);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[5]))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[4])) + (1 * (Fr_toInt(&lvar[5]) + 1))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
GreaterThan_6_run(mySubcomponents[cmp_index_ref],ctx);
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 56)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[3])) + 112);
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[3])) + 112)]].signalStart + 0],&circuitConstants[2]); // line circom 127
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 129
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 119
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[6]); // line circom 119
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 118
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 118
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[6]); // line circom 138
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[5];
// load src
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[5]); // line circom 139
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[3])) + 124);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * (Fr_toInt(&lvar[4]) + 1)) + (1 * Fr_toInt(&lvar[5]))) + 40)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
GreaterThan_6_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 56)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[3])) + 124);
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[3])) + 124)]].signalStart + 0],&circuitConstants[2]); // line circom 147
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 149
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 139
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[5]); // line circom 139
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 138
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[6]); // line circom 138
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[7]); // line circom 158
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[4])) + 136);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 56)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[4])) + 160);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[4])) + 136);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[4])) + 160);
Fr_sub(&expaux[1],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[4])) + 160)]].signalStart + 0]); // line circom 166
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[4])) + 136)]].signalStart + 0],&expaux[1]); // line circom 166
}}
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 166. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 158
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[7]); // line circom 158
}
for (uint i = 0; i < 184; i++){
uint index_subc = ctx->componentMemory[ctx_index].subcomponents[i];
if (index_subc != 0)release_memory_component(ctx,index_subc);
}
}
...
Futoshiki_7_create(1,0,ctx,"main",0);
Futoshiki_7_run(0,ctx);
}
